...
namespace Butterfly.HabboHotel.Items
{
    ...
    public class Item : IEquatable<Item>
    {
        ...
        {
            ItemData Data = null;
            if (ButterflyEnvironment.GetGame().GetItemManager().GetItem(mBaseItem, out Data))
            {
                this.Id = mId;
                this.RoomId = RoomId;
                ...
                this.GetAffectedTiles = Gamemap.GetAffectedTiles(this.GetBaseItem().Length, this.GetBaseItem().Width, this.mX, this.mY, Rot);
            }
        }
        ...
        public void ResetBaseItem()
        {
            ...
            this.GetAffectedTiles = Gamemap.GetAffectedTiles(this.GetBaseItem().Length, this.GetBaseItem().Width, this.mX, this.mY, this.Rotation);
        }
        ...
        public ItemData GetBaseItem()
        {
            ...
            {
                ItemData I = null;
                if (ButterflyEnvironment.GetGame().GetItemManager().GetItem(this.BaseItem, out I))
                    this._data = I;
            }
