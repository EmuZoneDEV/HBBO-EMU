...
namespace Butterfly.HabboHotel.Rooms
{
    ...
    public class Room
    {
        ...
        private ProjectileManager projecctileManager;
        ...
        {
            if (this.projecctileManager == null)
                this.projecctileManager = new ProjectileManager(this);
            return this.projecctileManager;
        }
        ...
        {
            return this.Bans.ContainsKey(pId);
        }

        public void RemoveBan(int pId)
        {
            this.Bans.Remove(pId);
        }
        ...
        public void AddBan(int pId, int Time)
        {
            if (this.Bans.ContainsKey(pId))
                return;
            this.Bans.Add(pId, (double)(ButterflyEnvironment.GetUnixTimestamp() + Time));
        }

        public bool HasBanExpired(int pId)
        {
            return !this.UserIsBanned(pId) || this.Bans[pId] - (double)ButterflyEnvironment.GetUnixTimestamp() <= 0.0;
        }
        ...
        {
            return this.Mutes.ContainsKey(pId);
        }

        public void RemoveMute(int pId)
        {
            this.Mutes.Remove(pId);
        }
        ...
        public static short CheckParse(char input)
        {
            switch (input)
            {
                case 'y':
