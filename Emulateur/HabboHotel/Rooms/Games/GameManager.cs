...
namespace Butterfly.HabboHotel.Rooms.Games
{
    public class GameManager
    {
        ...
        {
            foreach (RoomItem roomItem in this.redTeamItems.Values)
                this.ResetScore(roomItem);
            foreach (RoomItem roomItem in this.greenTeamItems.Values)
                this.ResetScore(roomItem);
            foreach (RoomItem roomItem in this.blueTeamItems.Values)
                this.ResetScore(roomItem);
            foreach (RoomItem roomItem in this.yellowTeamItems.Values)
                this.ResetScore(roomItem);
        }

        private void ResetScore(RoomItem item)
        {
