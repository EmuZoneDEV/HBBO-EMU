...
namespace Butterfly.HabboHotel.Rooms
{
    public class Gamemap
    {
        ...
        public DynamicRoomModel Model { get; }
        ...
        public void Destroy()
        {
            ...
            //this.userMap = (ConcurrentDictionary<Point, List<RoomUser>>)null;
            //this.mGameMap = (byte[,])null;
            //this.mUserItemEffect = (byte[,])null;
            //this.mItemHeightMap = (double[,])null;
            //this.mCoordinatedItems = (ConcurrentDictionary<Point, List<RoomItem>>)null;
            //this.mDynamicModel = (DynamicRoomModel)null;
            //this.room = (Room)null;
            //this.UserOnMap = (byte[,])null;
            //this.SquareTaking = (byte[,])null;
        }
    }
}
